...
public class CategoriaController {
     ...
     */
    @PostMapping
    public String crearCategoria(@ModelAttribute("categoria") Categoria categoria, Model model, RedirectAttributes rm) {
        try {
     ...
     */
    @PostMapping("/{id}")
    public String actualizarCategoria(@PathVariable Long id, @ModelAttribute("categoria") Categoria categoria, Model model, RedirectAttributes rm) {
        try {
