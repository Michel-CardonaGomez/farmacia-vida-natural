...
public class SubcategoriaController {
     ...
     */
    @PostMapping
    public String crearSubcategoria(@ModelAttribute("subcategoria") Subcategoria subcategoria, Model model, RedirectAttributes rm) {
        try {
     ...
     */
    @PostMapping("/{id}")
    public String actualizarSubcategoria(@PathVariable Long id, @ModelAttribute("subcategoria") Subcategoria subcategoria, Model model, RedirectAttributes rm) {
        try {
